//
//  HikingARViewController.swift
//  hikingbot
//
//  Created by KL on 15/4/2018.
...
@available(iOS 11.0, *)
class HikingARViewController: UIViewController, MKMapViewDelegate, SceneLocationViewDelegate {
  //Location to be displayed on the screen
  ...
  override func viewDidLoad() {
    ...
    updateInfoLabelTimer = Timer.scheduledTimer(
      timeInterval: 0.1,
      target: self,
      selector: #selector(HikingARViewController.updateInfoLabel),
      userInfo: nil,
      repeats: true)
    ...
    if showMapView {
      ...
      updateUserLocationTimer = Timer.scheduledTimer(
        timeInterval: 0.5,
        target: self,
        selector: #selector(HikingARViewController.updateUserLocation),
        userInfo: nil,
        repeats: true)
    }
      ...
      if touch.view != nil {
        if (mapView == touch.view! ||
          ...
          if location.x <= 40 && adjustNorthByTappingSidesOfScreen {
            ...
            /*
             print("top/bottom side of the screen")
             let image = UIImage(named: "pin")!
